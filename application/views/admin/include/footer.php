...
<script src="<?phpecho base_url('assets/admin/');?>bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
...
<script src="<?php echo base_url('assets/admin/dropzone/');?>dropzone.js"></script>
